...
import IntegrationAuth from "./components/pages/IntegrationAuth";
            ...
            <Router>
              ...
              <Switch>
                ...
                <Route
                  ...
                  render={(props) => (
                    <FormPage resetPassword={true} {...props} />
                  )}
                />
                <Route
                  path='/reset-password/'
                ...
                <Route
                  ...
                  render={(props) => (
                    <FormPage confirmEmail={true} {...props} />
                  )}
                />
                <Route
                  path='/auth/:provider/:token'
                  component={IntegrationAuth}
                />
